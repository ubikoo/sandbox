...
#ifndef RAYTRACE_CPU_WEEK_2_CAMERA_H_
#define RAYTRACE_CPU_WEEK_2_CAMERA_H_
...
struct Camera {
    ...
    double m_radius;                /* lens radius */

    /* Generate a new camera ray. */
    Ray generate_ray(
        const atto::math::vec2d &uv,
        const atto::math::vec2d &urand) const;
...
#endif /* RAYTRACE_CPU_WEEK_2_CAMERA_H_ */
