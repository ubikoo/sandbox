...
void Engine::execute(void)
{
     ...
     */
    {
        ...
        cl::Kernel::set_arg(m_kernels[KernelComputeForces], 3, sizeof(cl_float4), (void *) &m_gravity);
        cl::Kernel::set_arg(m_kernels[KernelComputeForces], 4, sizeof(cl_mem), (void *) &m_buffers[BufferParticles]);
        cl::Queue::enqueue_nd_range_kernel(
            m_queue,
