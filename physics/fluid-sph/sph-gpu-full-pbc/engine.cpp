    ...
    GLuint gl_point_vbo)
{
...

    {
        ...
        m_domain = Domain{bound_lo, bound_hi};
    }
...
void Engine::execute(void)
{
     ...
     */
    {
        ...
        cl::Kernel::set_arg(m_kernels[KernelCopyVertexData], 1, sizeof(cl_float), (void *) &Params::max_density);
        cl::Kernel::set_arg(m_kernels[KernelCopyVertexData], 2, sizeof(cl_mem), (void *) &m_buffers[BufferVertexData]);
        cl::Kernel::set_arg(m_kernels[KernelCopyVertexData], 3, sizeof(cl_mem), (void *) &m_buffers[BufferParticles]);
     ...
     */
    {
        ...
        cl::Kernel::set_arg(m_kernels[KernelUpdateBoundaries], 1, sizeof(cl_mem), (void *) &m_buffers[BufferParticles]);
        cl::Kernel::set_arg(m_kernels[KernelUpdateBoundaries], 2, sizeof(cl_mem), (void *) &m_buffers[BufferDomain]);
        cl::Queue::enqueue_nd_range_kernel(
            m_queue,
     ...
     */
    {
        ...
        cl::Kernel::set_arg(m_kernels[KernelComputeDensity], 1, sizeof(cl_float), (void *) &Params::kernel_radius);
        cl::Kernel::set_arg(m_kernels[KernelComputeDensity], 2, sizeof(cl_float), (void *) &Params::eos_kappa);
        cl::Kernel::set_arg(m_kernels[KernelComputeDensity], 3, sizeof(cl_float), (void *) &Params::eos_density);
        cl::Kernel::set_arg(m_kernels[KernelComputeDensity], 4, sizeof(cl_mem), (void *) &m_buffers[BufferParticles]);
        cl::Kernel::set_arg(m_kernels[KernelComputeDensity], 5, sizeof(cl_mem), (void *) &m_buffers[BufferDomain]);
        cl::Queue::enqueue_nd_range_kernel(
            m_queue,
        ...
        cl::Kernel::set_arg(m_kernels[KernelComputeForces], 1, sizeof(cl_float), (void *) &Params::kernel_radius);
        cl::Kernel::set_arg(m_kernels[KernelComputeForces], 2, sizeof(cl_float), (void *) &Params::viscosity);
        cl::Kernel::set_arg(m_kernels[KernelComputeForces], 3, sizeof(cl_mem), (void *) &m_buffers[BufferParticles]);
        cl::Kernel::set_arg(m_kernels[KernelComputeForces], 4, sizeof(cl_mem), (void *) &m_buffers[BufferDomain]);
        cl::Queue::enqueue_nd_range_kernel(
            m_queue,
