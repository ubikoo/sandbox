...
static const cl_uint load_factor = 256;         /* number of particle nodes per cell */
static const cl_uint k_empty = 0xffffffff;      /* empty cell mask */

/* OpenGL parameters */
static const int window_width = 1024;
static const int window_height = 1024;
static const char window_title[] = "sph-gpu-render";
...
struct Grid {
    struct Node {
        cl_uint key;        /* hash key of the particle position */
        cl_uint id;         /* value holding the particle index */
    };
    cl_uint capacity;       /* grid node capacity */
};
