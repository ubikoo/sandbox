...
void Model::draw(void *data)
{
    ...
    //         GLsizei j = 6*i;
    //         m_gl.point_vertex[j++] = m_engine.m_atoms[i].pos.x;
    //         m_gl.point_vertex[j++] = m_engine.m_atoms[i].pos.y;
    //         m_gl.point_vertex[j++] = m_engine.m_atoms[i].pos.z;
    //         m_gl.point_vertex[j++] = 1.0;
    //         m_gl.point_vertex[j++] = 0.0;
    //         m_gl.point_vertex[j++] = 0.0;
    //     }
    ...
    /* Control the polygon rasterization mode.*/
